...
## Embedded Knowledge
- pr-review-toolkit: code-reviewer, silent-failure-hunter, pr-test-analyzer, code-simplifier, type-design-analyzer, comment-analyzer
- developer-essentials: code-review-excellence
- feature-dev: code-reviewer (architecture-aware)
...
- Run the project's test suite (e.g., `pytest tests/ -x -q` or `npm run build`)
