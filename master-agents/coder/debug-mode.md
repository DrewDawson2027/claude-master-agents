...
## Embedded Knowledge
- debugging-toolkit:debugger: root cause analysis, evidence-based diagnosis
- debugging-toolkit:dx-optimizer: developer experience improvements
- debug-issue command: 8-step protocol
- developer-essentials:debugging-strategies: profiling, git bisect, differential debugging
